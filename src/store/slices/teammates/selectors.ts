...
export const selectTeammatesLoading = (state: RootState): boolean => state.teammates?.loading || false;
export const selectTeammatesError = (state: RootState): string | null => state.teammates?.error || null;
export const selectSelectedTeammate = (state: RootState): Teammate | null => state.teammates?.selectedTeammate || null;
