...
import { CustomObject, CustomObjectField, CustomFieldType, ValidationRule } from "@/types/customObject"

export const validateFieldValue = (value: any, field: CustomObjectField): string[] => {
    const errors: string[] = [];
