...
import { ChatProvider } from '@/context/ChatContextWithPlugins';
...
import { PluginManager } from './plugins/demo/PluginManager';
    ...
    <AblyProvider workspaceId={workspaceId}>
      <ChatProvider workspaceId={workspaceId}>
        <ThemeProvider initialTheme={theme}>
          {/* Plugin Manager to register and initialize plugins */}
          <PluginManager />
