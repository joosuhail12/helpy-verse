...
interface EnhancedStandaloneLayoutProps {
...
/**
 * Enhanced layout component for standalone widget mode with improved features
 */
const EnhancedStandaloneLayout: React.FC<EnhancedStandaloneLayoutProps> = ({
  currentPage,
  navigateTo,
  closeWidget,
  content
...
export default EnhancedStandaloneLayout;
