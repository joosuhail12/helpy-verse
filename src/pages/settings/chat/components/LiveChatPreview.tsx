        ...
        {showSideBySidePreview ? (
          <div className="grid grid-cols-2 gap-4 h-[600px] p-4 border-t border-gray-200">
            ...
            <div className="border border-gray-200 rounded-lg overflow-hidden shadow-md">
              ...
              <div className="relative h-[calc(100%-56px)] w-full max-w-[375px] mx-auto bg-gray-100 overflow-hidden">
                <div 
                  className="h-full w-full bg-white border-l border-r border-gray-300 overflow-hidden"
                >
                  <div
